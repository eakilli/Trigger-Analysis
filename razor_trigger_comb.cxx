...
void razor_trigger_comb(TString c_prodr, Float_t prodr, Float_t c_1, Float_t c_2, TString file_directory , TString input_file_name_1,TString input_file_name_2 , TString output_directory , TString output_file_name){
...
//	Float_t jet_eta[Njet_max];
	...
	mytree_1->SetBranchAddress("jet_n",&jet_n);
	mytree_1->SetBranchAddress("jet_pt",jet_pt);
	mytree_1->SetBranchAddress("Prod" , &Prod);
        mytree_1->SetBranchAddress("cosptR",&cosptR);
        mytree_1->SetBranchAddress("mdeltaR",&mdeltaR);
        mytree_1->SetBranchAddress("dphivbR",&dphivbR);
        mytree_1->SetBranchAddress("ptcm",&ptcm);
	mytree_1->SetBranchAddress("LeadPt",&LeadPt);


	//xe

	mytree_1->SetBranchAddress("xe_pt", &xe_pt);


	// XE, JET(L1) Histogram branches where the razor variables are defined

	mytree_1->SetBranchAddress("XE_pt",&XE_pt);
	mytree_1->SetBranchAddress("JET_n",&JET_n); // L1
	mytree_1->SetBranchAddress("JET_pt",JET_pt); // L1


	// Trigger information bool branches

	mytree_1->SetBranchAddress("4J20",&b_4J20);
	mytree_1->SetBranchAddress("2J30_XE40",&b_2J30_XE40);
	mytree_1->SetBranchAddress("HT200",&b_HT200);
	mytree_1->SetBranchAddress("XE70",&b_XE70);
	mytree_1->SetBranchAddress("2J10_XE60",&b_2J10_XE60);
 	mytree_1->SetBranchAddress("2J15_XE55",&b_2J15_XE55);
	mytree_1->SetBranchAddress("5j85_4J20",&b_5j85_4J20);
	mytree_1->SetBranchAddress("j150_xe90_J75_XE40",&b_j150_xe90_J75_XE40);
	mytree_1->SetBranchAddress("xe100_XE70",&b_xe100_XE70);
	mytree_1->SetBranchAddress("ht1000_HT200",&b_ht1000_HT200);


//	mytree_1->SetBRanchAddress("HT",&HT) ;
...
*/
	...
	razor_file_1->Close();
       ...
       // Open the file 2
        ...
        // Get the tree branches, tree 2, qcut 300
        ...
        mytree_2->SetBranchAddress("jet_n",&jet_n);
        mytree_2->SetBranchAddress("jet_pt",jet_pt);
        mytree_2->SetBranchAddress("Prod" , &Prod);
        mytree_2->SetBranchAddress("cosptR",&cosptR);
        mytree_2->SetBranchAddress("mdeltaR",&mdeltaR);
        mytree_2->SetBranchAddress("dphivbR",&dphivbR);
        mytree_2->SetBranchAddress("ptcm",&ptcm);
        mytree_2->SetBranchAddress("LeadPt",&LeadPt);

        //xe

        mytree_2->SetBranchAddress("xe_pt", &xe_pt);

        // XE, JET(L1) Histogram branches where the razor variables are defined

        mytree_2->SetBranchAddress("XE_pt",&XE_pt);
        mytree_2->SetBranchAddress("JET_n",&JET_n); // L1
        mytree_2->SetBranchAddress("JET_pt",JET_pt); // L1

        // Trigger information bool branches

        mytree_2->SetBranchAddress("4J20",&b_4J20);
        mytree_2->SetBranchAddress("2J30_XE40",&b_2J30_XE40);
        mytree_2->SetBranchAddress("HT200",&b_HT200);
        mytree_2->SetBranchAddress("XE70",&b_XE70);
        mytree_2->SetBranchAddress("2J10_XE60",&b_2J10_XE60);
        mytree_2->SetBranchAddress("2J15_XE55",&b_2J15_XE55);
        mytree_2->SetBranchAddress("5j85_4J20",&b_5j85_4J20);
        mytree_2->SetBranchAddress("j150_xe90_J75_XE40",&b_j150_xe90_J75_XE40);
        mytree_2->SetBranchAddress("xe100_XE70",&b_xe100_XE70);
        mytree_2->SetBranchAddress("ht1000_HT200",&b_ht1000_HT200);


//      mytree_2->SetBRanchAddress("HT",&HT) ;

        //Tree event loop, tree 2, QCUT300
...
//		cout << x << y << ":" <<per_overlap[x][y] << endl;
	...
	outputfile << "number of total events : (combined) : " << number_of_events <<
	" n_shatR : " << n_shatR <<
	"\n n_cosptR : " << n_cosptR <<
	"\n n_mdeltaR : " << n_mdeltaR <<
	"\n n_gaminvR : " << n_gaminvR <<
